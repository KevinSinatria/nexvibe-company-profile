...
const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Dziqqir",
    category: "Web Development",
    description: "Flatform qurban dan aqiqah",
...
const Portfolio = () => {
  ...
  return (
    <>
      <Head>
        <title>Nexvibe - Portofolio</title>
      </Head>
          ...
          <FadeInOnScroll>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
                Kami berkomitmen untuk memberikan solusi digital yang inovatif
                dan transformatif untuk setiap proyek yang kami kerjakan
              </p>
            </div>
          </FadeInOnScroll>
        </section>
            ...
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-8 md:p-12">
              <div className="max-w-3xl mx-auto text-center text-white">
                <blockquote className="text-xl md:text-2xl font-medium mb-6">
                  &quot;NexVibe telah membantu kami mengembangkan platform
                  digital yang luar biasa. Tim mereka sangat profesional dan
